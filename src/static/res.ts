...
export const resServicesRu = ['доставка', 'бронирование столиков', 'еда навынос', 'веранда'];
//Особвые события
...
//типизация входа
export const adminCheckResSchema = z.object({
  name: z.string(),
  email: z.email(),
});
export type adminCheckRes = z.infer<typeof adminCheckResSchema>;

export const userCheckResSchema = z.object({
  name: z.string(),
  email: z.email(),
  password: z
    .string()
    .min(4, 'Пароль должен быть минимум из 4 символов')
